...
public class Win開新視窗3 extends javax.swing.JFrame {
    ...
    private void JB1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JB1ActionPerformed
        ...
        Win開新視窗3w win2 = new Win開新視窗3w(this, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Win開新視窗3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
